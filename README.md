<div align="center">
    <a href="https://slmp.sh/" target="_blank">
        <img alt="slmp" src="https://github.com/slmpdottech/dist/raw/main/logo.png">
    </a>
	<h4> Simple Linux + Apache + MySQL/MariaDB + PHP Control panel</h4>
</div>

## Description

[slmp](https://slmp.sh/) is simple script for the installation of Apache + PHP + MySQL/MariaDB and so on. You can install Apache + PHP + MySQL/MariaDB in an very easy way, just need to choose what you want to install before installation. And all things will be done in few minutes.
...
bash <(wget -qO- https://slmp.sh/install)
...
- [Automation install mode](https://slmp.sh/auto)
```bash
./slmp.sh -h
```
...
```bash
./slmp.sh --apache_option 1 --apache_modules mod_wsgi,mod_security --db_option 1 --db_root_pwd slmp.com --php_option 1 --php_extensions apcu,ioncube,imagick,redis,mongodb,libsodium,swoole --db_manage_modules phpmyadmin,adminer --kodexplorer_option 1
```
...
- Auto transfer backup file to Google Drive (Depends on [`rclone`](https://slmp.sh/how-to-backup/) command) (option)
...
| Command        | Description                       |
|----------------|-----------------------------------|
| slmp add      | Create a new Apache virtual host  |
| slmp del      | Delete a Apache virtual host      |
| slmp list     | List all of Apache virtual hosts  |
| slmp wp       | Install wordpress                 |
| slmp version  | Print version and exit            |

## Bugs & Issues

Please feel free to report any bugs or issues to us, email to: hi@slmp.sh or [open issues](https://github.com/slmpdotsh/slmp/issues) on Github.


## License

Copyright (C) 2022 [slmp](https://slmp.sh/)
