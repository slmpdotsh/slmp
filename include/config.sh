...
#ImageMagick
ImageMagick_filename="ImageMagick-7.1.0-27"
ImageMagick_filename_url="https://download.imagemagick.org/ImageMagick/download/releases/ImageMagick-7.1.0-27.tar.gz"
